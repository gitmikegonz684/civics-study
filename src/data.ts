...
export const decks: Deck[] = [
    {
        id: 'civics-basics',
        name: '1. American Government: Principles of American Democracy',
        cards: [
            {
                id: '1',
    ...
    },
    {
        ...
        name: '2. American Government: System of Government',
        cards: [
            {
                id: '13',
    ...
    },
    {
        ...
        name: '3. American Government: Rights and Responsibilities',
        cards: [
            {
                id: '48',
    ...
    },
    {
        ...
        name: '4. American History: Colonial Period and Independence',
        cards: [
            {
                id: '58',
    ...
    {
        id: 'recent-american-history-and-other-important-historical-information',
        name: '6. American History: Recent American History and Other Important Historical Information',
        cards: [
            {
                id: '78',
            ...
            },
            {
                ...
                answer: '[USCIS Officers will be supplied with a list of federally recognized American Indian tribes.] Cherokee, Navajo, Sioux, Chippewa, Choctaw, Pueblo, Apache, Iroquois, Creek, Blackfeet, Seminole, Cheyenne, Arawak, Shawnee, Mohegan, Huron, Oneida, Lakota, Crow, Teton, Hopi, Inuit'
            }
        ]
    },
    {
        id: 'geography',
        name: '7. Integrated Civics: Geography',
        cards: [
            {
                id: '88',
    ...
    {
        id: 'symbols',
        name: '8. Integrated Civics: Symbols',
        cards: [
            {
                id: '96',
    ...
    {
        id: 'holidays',
        name: '9. Integrated Civics: Holidays',
        cards: [
            {
                id: '99',
